    ...
    <div className="flex flex-col items-center text-center lg:items-start lg:text-left">
      ...
      <div className="mt-8 flex flex-col items-center gap-3 lg:items-start">
        ...
        <div className="flex items-center gap-3">
          {/* App Store */}
          <a
            href={"https://apps.apple.com/cz/app/heatmapa/id6800734621?l=cs"}
            target="_blank"
            rel="noopener noreferrer"
            className="glass glass-card no-hover-card flex items-center gap-3 border border-white/10 bg-black/20 px-4 py-3 no-underline shadow-[0_30px_80px_rgba(0,0,0,0.3)] transition-colors duration-500 ease-out hover:border-white/20"
          ...
          >
            ...
            <div className="flex flex-col gap-0.5 leading-none">
              <span className="text-[9px] font-medium text-orange-400/80">{t.availableOn}</span>
          ...
          {/* Google Play */}
          <a
            href={"https://play.google.com/store/apps/details?id=cz.heatmapa.app&hl=cs"}
            target="_blank"
            rel="noopener noreferrer"
            className="glass glass-card no-hover-card flex items-center gap-3 border border-white/10 bg-black/20 px-4 py-3 no-underline shadow-[0_30px_80px_rgba(0,0,0,0.3)] transition-colors duration-500 ease-out hover:border-white/20"
            style={{ borderRadius: '12px' }}
